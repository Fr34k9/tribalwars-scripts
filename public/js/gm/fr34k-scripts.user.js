...
(function() {
	...
	if (url.includes("screen=overview_villages") && url.includes("mode=prod")) run$11();
	if (url.includes("screen=overview_villages") && url.includes("mode=incomings")) run$10();
	if (url.includes("screen=ally")) run$4();
	if (url.includes("screen=info_village")) {
		run$3();
		run$4();
	}
	...
	if (url.includes("screen=map")) run();
	if (url.includes("screen=place") || url.includes("screen=info_village") || url.includes("ds-ultimate.de") && url.includes("attackPlanner")) run$1();
})();
